...
export default function Exchange({ onClose }) {
  ...
  return (
    <SectionFrame title="Equivalent Exchange" sub="THE FIRST LAW" glyph="⚖" accent="gold" onClose={onClose}>
      ...
      <div className="exchange-split-grid">
        <div className="dossier-visuals">
          <div className="beat-fig">
            <img src="img/transmute-brothers.jpg" alt="Alchemical Transmutation Circle" loading="lazy" />
            <span className="visual-caption">AMESTRIS RESEARCH FILE: #1901_TRANS_CIRC</span>
          </div>
          <div className="beat-fig secondary-offset">
            <img src="img/al-child.jpg" alt="Alphonse Elric" loading="lazy" />
            <span className="visual-caption">SUBJECT A: ALPHONSE ELRIC [FILE_002]</span>
          </div>
        </div>
