...
const STEP_IMAGES = {
  COMPREHENSION: 'img/automail-name.jpg',
  DECONSTRUCTION: 'img/ed-deconstruct.jpg',
  RECONSTRUCTION: 'img/ed-pop.jpg'
};
...
export default function Alchemy({ onClose }) {
  ...
  return (
    <SectionFrame title="Alchemy" sub="DECONSTRUCT · RECONSTRUCT" glyph="✦" accent="teal" onClose={onClose}>
      ...
      <div className="alchemy-split-grid">
        <div className="alchemy-control-panel">
        ...
        <div className="alchemy-steps-panel">
